...
- 아트: SDXL 36후보는 품질 미달, Qwen 첫4+후속12 확대 검수 후 서로 다른8장면 WebP를 신규 공급했다.
  ...
  no-overwrite export를 구현했고, 실제 4장 종료→새 프로세스8장 재개를 확인했다. 현 단계 게임 연결과
  영상2개 웹용 변환은 진행 중이다(승리 사쿠라/강변 엘레나 채택, 빗소리 사쿠라2후보 반려).
...
- 승인된 다음 확장: Ch8~9와 Ch10~12 실제 졸업 SnG. Fable 검토 후 총괄 확정 설계는
  `docs/superpowers/specs/2026-09-05-act3-act4-design.md`. R3a 신규콤보/리딩/넛츠8종은 구현됐고 챕터 연결 중이다.
