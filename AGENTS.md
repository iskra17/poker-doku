...
- 아트: SDXL 36후보는 품질 미달, Qwen 첫4+후속12 확대 검수 후 서로 다른8장면 WebP를 신규 공급했다.
  ...
  영상2개 검증은 진행 중이다. 기존 이미지는 교체하지 않는다. 단발/큐 출처는 공급 manifest로 구별한다.
- R2 구현/통합 검토 중: Ch7의 관찰12핸드→가면4퀴즈→일괄 정답/정체 공개→최대10핸드 대응 대결.
...
- 승인된 다음 확장: Ch8~9와 Ch10~12 실제 졸업 SnG. 기획은 Fable 검토 후 총괄이 확정한다.
