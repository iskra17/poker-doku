 ...
 * - 성장축(A8): 에필로그에서 「접는 것도 배워 볼까」를 처음 입에 올린다 — 실제로 접는 클로이는 3막 이후.
        ...
        },
        {
          ...
          stages: [
            ...
            },
            {
              ...
              answer: { kind: 'multiple-choice', options: ['블라인드를 넓게 스틸하고, 레이즈를 맞으면 접기', '밸류는 크게 받고, 블러프는 하지 않기', '탑페어급으로 콜다운하고, 강한 핸드는 트랩', '포지션에서만 싸우고, 마지널 핸드는 피하기'], correctIndex: 1 },
