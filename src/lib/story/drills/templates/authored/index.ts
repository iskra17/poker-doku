...
import { ACT4_AUTHORED_DRILLS } from './act4';

export const AUTHORED_DRILL_TEMPLATES: readonly DrillTemplate[] = [...ACT1_AUTHORED_DRILLS, ...ACT2_AUTHORED_DRILLS, ...ACT3_AUTHORED_DRILLS, ...ACT4_AUTHORED_DRILLS];
