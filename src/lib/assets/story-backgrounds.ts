...
/** 실제로 배치된 이미지 id — 아트 배치 후 여기에 추가한다 (2026-09-03 1막 5장 전부) */
const AVAILABLE: ReadonlySet<string> = new Set<string>(['dojo-gate', 'dojo-table', 'dojo-garden-night', 'dojo-study', 'dojo-office']);
