...
// 히어로 아바타 원(xl 80px, 중심 ≈ 50%/88%-7px)의 7~8시 방향에 거의 붙는 좌표 —
// 처음 머리 위 중앙(50%,79%) → 왼쪽 아래(33%,91%)를 거쳐, "원 가장자리에 밀착"으로 확정
// (2026-07-22 유저 피드백 2회). 히어로 홀카드는 오른쪽 부착이라 왼쪽이 비어 있다.
const LAUNCHER_POS: TablePos = { x: '40%', y: '92%' };
