 ...
 */
export default function ChapterResult({ result, onClose, onNextChapter, onRetry, onRetrySparring, pending = false, onFullCourse, onOpenGallery }: ChapterResultProps) {
